...
If you want make use the github pipeline, you will need to add the public key to the `authorized_keys`:
...
IMPORTANT: Wait until the `migration` AND `bootstrap` is finished
