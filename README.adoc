...
[source,bash]
----
docker-compose -f dummy-webserver-compose.yml up -d
----
...
[source,bash]
----
docker-compose -f dummy-webserver-compose.yml down
----
...
[source,bash]
----
. ./.env && cat ./data/mailserver/config/opendkim/keys/${HOST}/mail.txt
----
