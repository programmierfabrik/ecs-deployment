...
Also add the public key to the `authorized_keys`:

[source,bash]
----
echo "command=\"sudo -u ecs /home/ecs/deployment/scripts/github-actions.sh \${SSH_ORIGINAL_COMMAND}\" ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIADAgVPUZvANgT9H3yrJJderSno276LnnGl0F9qNCPLo ecs.support@programmierfabrik.at" | sudo tee -a /home/github/.ssh/authorized_keys
----
